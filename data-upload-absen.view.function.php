...
function isian_komisi($counter = "#counter#", $nilai = 0, $id_model = "", $id_transaksi = ""){
	return str_replace("\r\n", "", "<span id=\"komisi_view_". $counter ."\" >" . number_format($nilai) . "</span>
		<input type=\"hidden\" id=\"komisi_". $counter ."\" name=\"komisi_". $counter ."\" value=\"" . $nilai . "\" />");
}
