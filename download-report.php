...
function download(){
	...
	jalankan_proses_di_iframe('download-report.php?c='+mode+'&area=<?=$cabang?>&periodeid=<?=@$_REQUEST["periodeid"]?>');
}
</script>
<style>
...
<div style="background-image:url('images/18-512.png'); background-repeat:no-repeat; background-position:center; height:97%;">
	...
	<ul style="margin-top:-47px; margin-left:-27px">
		<li><input type="radio" name="cb" id="cb1" value="ringkas" checked><label for="cb1">Report komisi SPG/M dalam tampilan ringkas</label><br /><div style="padding-left:27px">Download reporting excel berisi baris data SPG/M dengan informasi target, realisasi, komisi fix, komisi, komisi campaign, komisi total dan lain-lain.</div></li>
		<li><input type="radio" name="cb" id="cb2" value="detail"><label for="cb2">Report komisi SPG/M dalam tampilan detail</label><br /><div  style="padding-left:27px">Download report excel yang berisi detail lengkap perhitungan komisi SPG/M termasuk rincian item penjualan, kuantitas dan harganya masing-masing. Data SPG/M dipisahkan dalam sheet yang berbeda di report excel (nama sheet dalam nama SPG/M).</div></li>
	</ul>
	</p>
