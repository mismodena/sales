...
<div style="float:left; width:37%; padding-left:1px; padding-top:13px">
	...
	<div style="padding-top:3px">
		<input type="button" id="b_kembali" value="<< Kembali" style="width:177px" class="tombol-harus-difilter"
			...
			<input type="button" id="b_kembali" value="Log Out" style="width:177px" class="tombol-harus-difilter"
...
<div style="float:right; width:47%; border-left:1px solid #666; padding-left:17px; padding-top:13px">
	<table class="table-header">
		<tr>
			<td>Periode Penjualan</td><?//echo $s_tanggal_awal_formatted_v;?>
		...
		<tr>
			...
			<td><?=@number_format($s_grand_total_sellin)?></td>
		</tr>
		<tr>
			<td>Total Penjualan Setelah Pajak (Rp)<br />Pada rentang periode di atas</td>
			<td valign="top">
				<?=@number_format( ($s_grand_total_sellin / 1.1))  ?>
		...
		<tr>
			...
			<td valign="top">
				<?=$data_penjualan["target"] > 0 ? round( ($s_grand_total_sellin/1.1) / $data_penjualan["target"], 4) * 100 : 0 ?>
			</td>
		</tr>			
	</table>
</div>
...
<tr>
	<td colspan="12" style="text-align:left">
		...
		<div style="float:right; border:none 1px black; text-align:right">
		...
		<input type="button" id="b_simpan" value="Simpan Data" style="width:177px; background-color:green" class="tombol-harus-difilter"
			...
			<div style="padding-top:13px">*). <strong>Untuk menghapus data, isikan nol (0) pada isian "Jumlah".</strong></div>
		</div>
	</td>
</tr>
