...
function verifikasi(){
	...
	jalankan_proses_di_iframe('done_pajak-2.php?c=mulai_proses&area=<?=$_REQUEST['area']?>&periode=<?=$_REQUEST['periode']?>');
}
</script>
<div style="background-image:url('images/18-512.png'); background-repeat:no-repeat; background-position:center; ">
	<p>Anda akan mengirimkan email bahwa upload PPh21 mitra modena sudah selesai untuk cabang <?=$_REQUEST['area']?>
