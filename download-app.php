...
function download(){
	...
	jalankan_proses_di_iframe('download-app.php?c=1&area=<?=$cabang?>&periodeid=<?=@$_REQUEST["periodeid"]?>');
}
</script>
<style>
...
<div style="background-image:url('images/18-512.png'); background-repeat:no-repeat; background-position:center; height:97%;">
	...
	<ul style="margin-top:-47px; margin-left:-27px">
		<li><input type="radio" name="cb" id="cb1" value="ringkas" checked><label for="cb1">Report Hasil Perhitungan komisi</label><br /><div style="padding-left:27px">Download reporting excel berisi baris data SPG/M dengan informasi target, realisasi, komisi fix, komisi, komisi campaign, komisi total dan lain-lain.</div></li>
		<!--
